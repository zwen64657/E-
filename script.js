...
// 添加页脚功能
function addFooter(pageIndex) {
    const footer = document.createElementNS('http://www.w3.org/2000/svg', 'text');
    footer.classList.add('page-footer');
    footer.setAttribute('x', 827 - parseInt(marginRight.value));
    footer.setAttribute('y', 1169 - 20);
    ...
    footer.textContent = `第 ${pageIndex + 1} 页 / 共 ${totalPages} 页`;
...
// 添加页脚到PDF页面
function addFooterToPdf(svg, pageIndex) {
    const footer = document.createElementNS('http://www.w3.org/2000/svg', 'text');
    footer.setAttribute('x', 827 - parseInt(marginRight.value));
    footer.setAttribute('y', 1169 - 20);
    footer.setAttribute('font-family', 'Arial, sans-serif');
